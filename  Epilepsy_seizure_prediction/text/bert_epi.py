...
# Define the model name for sequence classification (replace with the appropriate model)
...
# Load the dataset
dataset = load_dataset("wbxlala/Epilepsy_seizure_prediction_str")
...
def tokenize_text(examples):
    return tokenizer((examples['sample']),truncation=True,max_length=521, )
